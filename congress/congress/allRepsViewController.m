...
#import "allRepsViewController.h"
#import "RepresentitiveSearchController.h"
#import "congressmenDetailViewController.h"


@interface allRepsViewController () <UITableViewDataSource>
...
@implementation allRepsViewController
...
- (void)viewDidLoad {
    ...
    [self.searchController allRepresentatives:^(NSArray *reps) {
